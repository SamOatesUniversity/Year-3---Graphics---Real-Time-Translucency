...
private:
	...
	struct Timer {
		enum Enum {
			...
			LBuffer_SpotLightFirstPass0,
			LBuffer_SpotLightSecondPass0,
			LBuffer_SpotLightFirstPass1,
			LBuffer_SpotLightSecondPass1,
			LBuffer_SpotLightFirstPass2,
			LBuffer_SpotLightSecondPass2,
			LBuffer_SpotLightFirstPass3,
			LBuffer_SpotLightSecondPass3,
			LBuffer_SpotLightFirstPass4,
			LBuffer_SpotLightSecondPass4,
			LBuffer_SpotLightFirstPass5,
			LBuffer_SpotLightSecondPass5,
			PostProcessing,
			Noof
		};
	};
